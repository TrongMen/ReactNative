...
export default function Screen1() {
  ...
  return (
    <View style={styles.container}>
        ...
        <Image style={{marginTop:20,flex:3,width:'100%', height:'auto', resizeMode:'contain'}} source={require('.//assets//Image95.png')}></Image>
        ...
        <Image style={{ left: 10, width: 20, height: 20, resizeMode: 'contain', position: 'absolute' }} source={require('.')}></Image>
